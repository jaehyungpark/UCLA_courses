...
#define INPUT_NEURON_NUM 9
#define OUTPUT_NEURON_NUM 2
...
int main(int argc, char **argv)
{
    ...
    FILE *fp;
    fp = fopen(argv[1], "r+");
    //There are total four types of movement which means we will have a 2*2 confusion matix
    // turn, walk, stairs, run
    int conf_matrix[OUTPUT_NEURON_NUM][OUTPUT_NEURON_NUM] = {{0,0},{0,0}};
    int answer[OUTPUT_NEURON_NUM] = {-1,-1};
    int answerLoc;
    int numLines = 0;
    int inN = 0;
    int outN = 0;
